...
<section class="centralBlock">
	<div>
		...
		<form
			...
			%>
			<input type="hidden" name="<%=ParameterNames.ID_TIENDA%>"
				value="<%=t.getId()%>"> <input

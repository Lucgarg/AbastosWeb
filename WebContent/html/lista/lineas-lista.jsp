...
<%@include file= "/html/lista/right-nav.jsp"%>
	<section class="tiendas producto">
		...
		for(LineaLista l : results.getLineaLista()){
			...
			<div>
				<figure>
					<img src=" <%=UrlBuilder.builderImg(request, "producto/" + l.getIdProducto() + "-principal.jpg")%>" alt="">
				</figure>
				<p>
					<a href="<%=UrlBuilder.builder(request, ViewPathsActions.PRODUCTO_ACTION_DETALLE)%><%=l.getIdProducto()%>"><%=l.getNombreProducto()%></a>
				</p>

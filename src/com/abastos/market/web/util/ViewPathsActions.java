...
public class ViewPathsActions {
	...
	public static final String PRECREATE_ACTION_OFERTA = 	"precreate?action=oferta";
	public static final String PRECREATE_ACTION_INDEX = "precreate?action=index";
	public static final String PRECREATE_ACTION_PRODUCTO = "precreate?action=producto";
	...
	public static final String PRECREATE_ACTION_TIENDA = 	"precreate?action=empresa";
	...
	public static final String OFERTA_ACTION_BUSCAR = "oferta?action=buscar";
